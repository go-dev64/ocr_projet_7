...
def combinaisons(p, n):
    ...
    liste_combinaisons.append(
        tuple(indices))  # conversion de la liste des indices en tuple puis ajout à la liste des combinaisons
    ...
    while (i != -1):  # tant qu'il reste encore des indices à incrémenter
        ...
        for j in range(i + 1, p):  # on recale les indices des éléments suivants par rapport à indices[i]
